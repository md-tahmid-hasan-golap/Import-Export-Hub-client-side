                ...
                >
                  ...
                  <td className="py-2 px-4">
                    <Link
                      ...
                      className="py-2 px-5 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white font-semibold rounded-lg shadow-lg hover:from-pink-500 hover:to-red-500 transition flex items-center gap-2"
                    >
                      See Details →
                    </Link>
                  </td>
